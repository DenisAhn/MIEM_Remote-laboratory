...
function Header() {
    ...
    return (<AppBar sx={Object.assign(Object.assign(Object.assign({ boxShadow: 'none', zIndex: theme.zIndex.appBar + 1 }, bgBlur({
            color: theme.palette.background.default,
        })), { transition: theme.transitions.create(['height'], {
                duration: theme.transitions.duration.shorter,
            }) }), Object.assign({ width: `calc(100% - ${NAV.W_DASHBOARD + 1}px)`, height: HEADER.H_DASHBOARD_DESKTOP }, (isOffset && {
