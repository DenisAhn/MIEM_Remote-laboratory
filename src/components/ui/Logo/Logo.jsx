...
const Logo = React.forwardRef((_a, ref) => {
    var { disabledLink = false, sx } = _a, other = __rest(_a, ["disabledLink", "sx"]);
    const logo = React.useMemo(() => (<Box ref={ref} component="div" sx={Object.assign({ width: 101, height: 30, display: 'inline-flex' }, sx)} {...other}>
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="213.000000pt" height="214.000000pt" viewBox="0 0 213.000000 214.000000" preserveAspectRatio="xMidYMid meet">
...
-1z"/>
    ...
    return (<Link component={RouterLink} to="/main/async  " sx={{ display: 'contents' }}>
        {logo}
      </Link>);
});
export default Logo;
