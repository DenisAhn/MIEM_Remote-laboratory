...
export default function Fab(theme) {
    ...
    const rootStyle = (ownerState) => {
        ...
        })), (inheritColor && Object.assign({}, (!isLight && {
            color: 'inherit',
            backgroundColor: theme.palette.grey[800],
            '&:hover': {
                backgroundColor: theme.palette.grey[700],
            },
        })))))), ((outlinedVariant || outlinedExtendedVariant) && Object.assign(Object.assign({ boxShadow: 'none', backgroundColor: 'transparent' }, ((defaultColor || inheritColor) && {
            border: `solid 1px ${alpha(theme.palette.grey[500], 0.32)}`,
            '&:hover': {
                backgroundColor: theme.palette.action.hover,
            },
        })), (defaultColor && Object.assign({}, (!isLight && {
        ...
        const disabledState = {
            '&.Mui-disabled': Object.assign({}, ((outlinedVariant || outlinedExtendedVariant) && {
                backgroundColor: 'transparent',
                border: `solid 1px ${theme.palette.action.disabledBackground}`,
            })),
        };
        const size = Object.assign({}, ((extendedVariant ||
            outlinedExtendedVariant ||
            softExtendedVariant) && Object.assign(Object.assign(Object.assign({ width: 'auto', '& svg': {
